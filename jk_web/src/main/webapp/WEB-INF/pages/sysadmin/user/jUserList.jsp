    ...
    <div id="menubar">
        <div id="middleMenubar">
            <div id="innerMenubar">
                <div id="navMenubar">
                    <ul>
                        <li id="view"><a href="javascript:toView('userAction_toview')">查看</a></li>
                        ...
                        <li id="update"><a href="#" onclick="javascript:toRole('userAction_torole')">角色</a></li>
                        <li id="delete"><a href="#" onclick="toDelete('userAction_delete')">删除</a></li>
                    </ul>
                </div>
            </div>
        </div>
