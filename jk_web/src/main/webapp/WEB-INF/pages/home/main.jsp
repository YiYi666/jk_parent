...
<style>
	.curbody{ CURSOR: url(${ctx}/skin/default/images/olmsg/shubiao.ani);background:url(${ctx}/skin/default/images/olmsg/pic738x571.jpg); }
...
<logic:notEmpty name="olmsgList">
		...
		<div id='ff8080813d00613e013d0067909e0009' style='position:absolute;left:122px;top:97px;z-index:1001; height:164px;background:none;' onmousedown='getFocus(this)'>
			<table border=0 cellspacing="0" cellpadding="0" width="220">
				<tr>
					<td style='cursor:move;' onmousedown="MDown(this,'ff8080813d00613e013d0067909e0009')" background="${ctx}/skin/default/images/olmsg/C0FFE51.gif" height="45">
				...
				<tr>
					<td style='cursor:move;white-space:nowrap;' width='100%' onmousedown="MDown('ff8080813d00613e013d0067909e0009')" background="${ctx}/skin/default/images/olmsg/C0FFE52.gif" >
						...
						<div style="float:right;width:80px;text-align:right;padding-right:7px;">
							...
							<a style='cursor:pointer;' title="编辑" onclick="msgupdate('ff8080813d00613e013d0067909e0009','edit')"><img src="${ctx}/skin/default/images/olmsg/doc_edit.gif"/></a>
							...
							<a style='cursor:pointer;' title="删除" onclick="msgdel('ff8080813d00613e013d0067909e0009')"><img src="${ctx}/skin/default/images/olmsg/doc_del.gif"/></a>
				...
				<tr>
					<td background="${ctx}/skin/default/images/olmsg/C0FFE52.gif">
				...
				<tr>
					<td id="tagBPic" background="${ctx}/skin/default/images/olmsg/C0FFE53.gif" height="63">
						<table border="0" width="100%" cellspacing="0" cellpadding="0">
							<tr>
								<td width="50" align="center">
								<img border="0" src="${ctx}/skin/default/images/olmsg/2.gif">
								</td>
		...
		<div id='ff8080813d00613e013d00681494000a' style='position:absolute;left:442px;top:91px;z-index:1002; height:164px;background:none;' onmousedown='getFocus(this)'>
			<table border=0 cellspacing="0" cellpadding="0" width="220">
				<tr>
					<td style='cursor:move;' onmousedown="MDown(this,'ff8080813d00613e013d00681494000a')" background="${ctx}/skin/default/images/olmsg/FFE7E81.gif" height="45">
				...
				<tr>
					<td style='cursor:move;white-space:nowrap;' width='100%' onmousedown="MDown('ff8080813d00613e013d00681494000a')" background="${ctx}/skin/default/images/olmsg/FFE7E82.gif" >
						<div style="float:left;width:130px;padding-left:7px;font-family:Tahoma;color:gray;font-style : oblique;">
							2013-02-22 13:37
						</div>
						<div style="float:right;width:80px;text-align:right;padding-right:7px;">
							...
							<a style='cursor:pointer;' title="编辑" onclick="msgupdate('ff8080813d00613e013d00681494000a','edit')"><img src="${ctx}/skin/default/images/olmsg/doc_edit.gif"/></a>
							...
							<a style='cursor:pointer;' title="删除" onclick="msgdel('ff8080813d00613e013d00681494000a')"><img src="${ctx}/skin/default/images/olmsg/doc_del.gif"/></a>
				...
				<tr>
					<td background="${ctx}/skin/default/images/olmsg/FFE7E82.gif">
					<div class="msgcontent">
					本系统实现货运企业日常管理<br />
包括合同、报运、装箱、委托、发票等业务
					</div>
				...
				<tr>
					<td id="tagBPic" background="${ctx}/skin/default/images/olmsg/FFE7E83.gif" height="63">
						<table border="0" width="100%" cellspacing="0" cellpadding="0">
							<tr>
								<td width="50" align="center">
								<img border="0" src="${ctx}/skin/default/images/olmsg/0.gif">
								</td>
								<td style="text-align:right;padding-right:8px;" nowrap>
								[备忘]
