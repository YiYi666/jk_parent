 ...
 * 
 */
@WebServiceClient(name = "EpServiceService", targetNamespace = "http://webservice.yaorange.com/", wsdlLocation = "http://localhost:88/jk_export/ws/export?wsdl")
    ...
    extends Service
{
    ...
    private final static QName EPSERVICESERVICE_QNAME = new QName("http://webservice.yaorange.com/", "EpServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:88/jk_export/ws/export?wsdl");
    ...
    public EpService getEpServicePort() {
        return super.getPort(new QName("http://webservice.yaorange.com/", "EpServicePort"), EpService.class);
    }
    ...
    public EpService getEpServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservice.yaorange.com/", "EpServicePort"), EpService.class, features);
    }
